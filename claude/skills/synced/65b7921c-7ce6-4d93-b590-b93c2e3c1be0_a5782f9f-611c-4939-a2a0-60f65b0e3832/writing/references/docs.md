...
Activated by `--docs`. Layer on top of slop for API docs, PRDs, ADRs, README, runbooks, marketing landing pages.
...
Full annotated list: [banned-words.md](banned-words.md).
