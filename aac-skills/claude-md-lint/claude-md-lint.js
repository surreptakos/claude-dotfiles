 ...
 * going red, plus `volatile`, `code-derivable` and `tutorial` on `profile/claude/CLAUDE.md`, the
 * owner's global rules text, whose prose quotes counterexamples that trip those regexes on
 * purpose. A warn-only finding prints like any other and does not set the exit code,
...
const PATH_WARN_ONLY = Object.freeze([
  { suffix: 'profile/claude/CLAUDE.md', rules: Object.freeze(['size', 'volatile', 'code-derivable', 'tutorial']) },
]);
...
module.exports = {
  ...
  WARN_ONLY_DEFAULT, PATH_WARN_ONLY,
};
