 ...
 * running yesterday's copy without anyone saying so.
 *
 * The stamp file records the state at the last recorded publish (`--stamp` writes it). A later
 * edit to any skill moves the fingerprint away from the stamp and the sweep reports drift,
 * naming the skill.
 *
