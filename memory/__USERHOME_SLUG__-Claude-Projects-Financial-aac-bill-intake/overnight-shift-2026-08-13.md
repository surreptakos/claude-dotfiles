...
Open threads: 125 (verify per-cause tag names on a live ticket), 128 (owner ruled 2026-08-13: zero BILL policies IS intended under 119 — gate goes inert-by-design at policyCount 0; ready-for-agent), 134 (parallel drain), 135 (no-document email class, 11 tickets), 70 (awaits organic NO-VENDOR). See [[urlfetch-quota-is-the-ceiling]] and [[owner-ruling-registry-membership-wo]].
