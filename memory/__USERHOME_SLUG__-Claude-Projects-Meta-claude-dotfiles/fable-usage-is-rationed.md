...
description: Dan's Fable 5.1 usage is capped per week; never move fleet or subagent workers onto Fable, keep the Opus 4.7 / Sonnet 5 / Haiku pins
metadata:
  type: feedback
---

Fable 5.1 weekly usage on Dan's account is limited. Fleet and orchestrator worker model pins
(`implModel: claude-opus-4-7`, `verifyModel: claude-sonnet-5`, Haiku for deliver/report) stay as
they are, even though the Fable prompting guide says Fable at `medium` or `low` is cheaper per task.
