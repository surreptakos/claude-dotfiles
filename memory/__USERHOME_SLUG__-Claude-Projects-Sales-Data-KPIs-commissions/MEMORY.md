...
- [Sheet REST API access](sheet-rest-api-access.md) — clasp token = FULL 20-scope grant (verified 2026-08-17); re-auth ONLY via `node tools/clasp-auth.js` (creds JSON in OneDrive Downloads, tools search it since 2026-08-17); run fns via clasp run-function (public only) or headless doPost web app; DriveApp auth = declared-vs-granted gap
...
- [Deal_Number join DEPLOYED](deal-number-join-deployed.md) — PR #17 live 2026-08-12, #16 closed, #15 unblocked; OSH-Patterson CO1 skip is correct
