...
async function driveCodeLane(scriptPath, agentMock, ticket, workerIndex = 0, invocationId = 'inv1') {
  ...
  const runCodeLane = await wrapper(agentMock, (m) => logs.push(m), cfg, runId, invocationId, scout, {}, {}, {}, {}, 'gh', rules);
