...
- classifier-refusals-are-shape-not-action: retry
- cloud-containers-can-run-powershell: 7.4.6 tarball
- cloud-home-snapshot: seat in $HOME
...
- hook-exit-126-is-the-mode-bit: diag log; seat root
...
- session-env-carries-zoho-and-gas-tokens: names
...
- verify-before-filing-a-sweep-ticket: re-list
