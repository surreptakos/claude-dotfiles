...
Pinned to AAC-WR-001 v0.9, the version TERMINOLOGY.md records for Part XXV.
"""
import re
import sys

STANDARD_VERSION = "0.9"
...
CHECKS = [
    ...
    # --------------------------------------------------------- Appendix G12
    # Machine vocabulary. Rule 9: plain language. Adopted company-wide, not
    # scoped to one document class (issue 626). beacon, harness, gate and
    # robust are named AAC equipment and engineering properties and are
    # exempt by the controlled copy - they are not in this list at all.
    _c("G12", 9, "ERROR",
       r"\bdelv(?:e|es|ed|ing)\b",
       "machine vocabulary; cut or replace",
       "Appendix G12"),
    _c("G12", 9, "ERROR",
    ...
    _c("G12", 9, "ERROR",
       ...
       "machine vocabulary; use 'analysis' or 'examination'",
       "Appendix G12"),
    _c("G12", 9, "ERROR",
    ...
    _c("G12", 9, "ERROR",
       ...
       "Appendix G12"),
    _c("G12", 9, "ERROR",
       r"\bgame[- ]changer\b|\bgame changer\b|\bgame[- ]changing\b",
       "machine vocabulary; use 'significant' or 'important'",
       "Appendix G12"),
