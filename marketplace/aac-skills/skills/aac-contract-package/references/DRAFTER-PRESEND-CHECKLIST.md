...
30. File name reflects **every** system in the package and the site. A system whose name contains a character Windows forbids in file names is spelled with that character replaced by a space, so Audio/Visual is written `Audio Visual` (ruling on #328, ratified by Dan 2026-09-24).
