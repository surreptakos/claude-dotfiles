...
| `SOW-BASELINES.md` | SOW templates for all sold system types (§7.1–§7.12 + fallback rule), approved system names, designation tokens | Active. §1 per-System labelled paragraph form and §3 Contract family column **awaiting Dan's signature (2026-09-10, spec 215 stream B, ADR-0001, issue 218)** |
