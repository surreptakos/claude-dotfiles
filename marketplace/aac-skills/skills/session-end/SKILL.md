...
metadata:
  modified: '2026-09-16T04:41:24Z'
  previous-modified: '2026-09-15T22:34:53Z'
  revision: '4'
  content-sha: de578922ae0c
---
...
If any step in 1–11 is blocked, name the blocker, list what IS done, and stop; `Ready to archive`
is reserved for a state the user can archive without checking.
