...
metadata:
  ...
  previous-modified: '2026-09-02T19:03:20Z'
  revision: '1'
...
```bash
node "${CLAUDE_PLUGIN_ROOT}/skills/session-check/cloud-plugin-sweep.js" --stamp --version <version> --accounts <every account uploaded to>
node "${CLAUDE_PLUGIN_ROOT}/skills/session-check/cloud-plugin-sweep.js"
```
